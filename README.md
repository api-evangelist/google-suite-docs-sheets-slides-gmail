# Google Workspace Suite (google-suite-docs-sheets-slides-gmail)
...
- **Human URL:** [https://developers.google.com/docs](https://developers.google.com/docs)
...
- [Postman Collection](collections/google-suite-docs-sheets-slides-gmail.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/google-suite-docs-sheets-slides-gmail.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)

### Google Sheets API

API for reading and modifying Google Sheets spreadsheets.

- **Human URL:** [https://developers.google.com/sheets](https://developers.google.com/sheets)
...
- [Pricing](https://developers.google.com/sheets/api/limits)
- [Postman Collection](collections/google-suite-docs-sheets-slides-gmail.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/google-suite-docs-sheets-slides-gmail.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)
...
- **Human URL:** [https://developers.google.com/gmail](https://developers.google.com/gmail)
...
- [Authentication](https://developers.google.com/gmail/api/auth)
